export const securityHeadersPlugin = async (c: any, next: any) => {
  ...
  c.header(
    ...
    [
      ...
      "img-src 'self' data: blob: https://img.youtube.com https://i.ytimg.com https://raw.githubusercontent.com https://p16-sign.tiktokcdn.com https://p16-sign-sg.tiktokcdn.com",
      "media-src 'self' blob: https:",
      `connect-src 'self' https://generativelanguage.googleapis.com https://api.stripe.com ${r2Base}`,
      "frame-src https://www.youtube.com https://www.tiktok.com https://js.stripe.com",
      "object-src 'none'",
      "base-uri 'self'",
